        ...
        <div>
            ...
            <div>
                ...
                key={index}>
                    ...
                    <p className='
                    text-neutral-800 font-semibold'>{item.name}</p>
                    <p>{item.speciality}</p>

                    <p className='text-zinc-700 font-medium mt-1'>Address:</p>
                    <p text-xs>{item.address.line1}</p>
                    <p text-xs>{item.address.line2}</p>

                    <p text-xs mt-1>
                        <span className='text-sm text-neutra-700 font-medium'>Date & Time:</span> 25, July, 2024 | 8:30 PM
                    </p>
                    </div>
                    <div></div>
